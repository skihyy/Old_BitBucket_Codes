...
public class NumberOfOccurrencesTest
{
	...
	public static void main(String[] args)
	{
		...
		System.out.println();
		System.out.println(l1.numberOfOccurrences(l1, 9));
		System.out.println(l1.numberOfOccurrences(l2, 3));
		System.out.println(l1.numberOfOccurrences(l3, 3));
		System.out.println(l1.numberOfOccurrences(l4, 1));
	}
